...
The VDP Video Modes is selected by the Bits M1-M4 of VDP Register 0 and 1. The relationship between the bits and the screen is:
<pre>
  M1 M2 M3 M4 Screen format
  0  0  0  0  Half text  32x24             (Mode 0 - Graphic 1)
  1  0  0  0  Text       40x24             (Mode 1 - Text)
  0  0  1  0  Hi resolution 256x192        (Mode 2 - Graphic 2)
  0  1  0  0  Multicolour  4x4pix blocks   (Mode 3 - Multicolor)
</pre>
**Mode 0**: 240x192 pixels total, as 40x24 characters, pulled from 1 character set of 256 6x8 pixel characters. The entire character set has a 2-color limitation. This mode doesn't support sprites.  
**Mode 1**: 256x192 pixels total, as 32x24 characters, pulled from 1 character set of 256 8x8 pixel characters. Each group of 8 characters in the character set has a 2-color limitation. For example, the characters "0" through "7" will all have the same color attributes.  
...
<pre>
  Bit  Name       Expl.
  0-4  SP0-4      Number for the 5th sprite (9th in screen 4-8) on a line
...
**Register 2: Name Table Base Address, 1K boundaries**  
<pre>
  Bit     7    6    5    4    3    2    1    0
...
**Register 3: Color Table Base Address, 64-byte boundaries**  
<pre>
  Bit     7    6    5    4    3    2    1    0
...
**Register 4: Pattern Generator Base Address, 2K boundaries** 
<pre>  
  Bit     7    6    5    4    3    2    1    0
...
**Register 5: Sprite Attribute Table Base Address, 128-byte boundaries**  
<pre>
  Bit     7    6    5    4    3    2    1    0
...
**Register 6: Sprite Pattern Generator Base Address, 2K boundaries** 
<pre>
  Bit     7    6    5    4    3    2    1    0
  Name    0    0    0    0    0   A00  A01  A02
</pre>
...
**Register 7: Text color / background color**  
<pre>
  Bit  Name       Expl.
...
### VDP Registers 0Ah-39h: Additional F18A Video Registers  

**Register 0A: Name Table 2 Base Address, 1K boundaries** 
<pre>
  Bit     7    6    5    4    3    2    1    0
  Name    0    0    0    0   A00  A01  A02  A03
</pre>
...
**Register 0B: Color Table 2 Base Address, 64-byte boundaries**
<pre>
  Bit     7    6    5    4    3    2    1    0
  Name   A00  A01  A02  A03  A04  A05  A06  A07
</pre>
...
**Register 18: Extra palette-select bits for original color modes**  
<pre>
  Bit  Name       Expl.
  0-1  T1PS01-1   Tile 1 layer
  2-3  T2PS0-1    Tile 2 layer
  4-6  SPS0-1     Sprite
  6-7  0          Not used
</pre>
...
**Register 30: SIGNED two's-complement increment amount for VRAM address, defaults to 1**  
<pre>
  Bit  Name       Expl.
  0-6  INC0-6     Value
